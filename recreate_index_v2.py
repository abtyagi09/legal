"""Script to recreate index using raw field definitions"""
import asyncio
import os
...
async def recreate_index():
    ...
    try:
        ...
        # Create new index with correct schema using SearchField for collection
        ...
        index = SearchIndex(
            ...
            fields=[
                ...
                SimpleField(name="upload_date", type="Edm.String", sortable=True),
                ...
                SimpleField(name="owner_id", type="Edm.String", filterable=True),
                SearchField(
                    name="allowed_users",
